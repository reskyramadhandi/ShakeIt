...
package edu.upi.mobprog18.tubes_1607479_resky_1600872_agung.shakeit.ringtone.playback;
...
public class AlarmRingtoneService extends RingtoneService<Alarm> {
    ...
    private static final String ACTION_SNOOZE = "com.philliphsu.clock2.tubes_1607479_resky_1600872_agung.shakeit.ringtone.action.SNOOZE";
    private static final String ACTION_DISMISS = "com.philliphsu.clock2.tubes_1607479_resky_1600872_agung.shakeit.ringtone.action.DISMISS";
    ...
    public int shakesToStop() {
        return AlarmPreferences.shakesCount(this);
    }
}

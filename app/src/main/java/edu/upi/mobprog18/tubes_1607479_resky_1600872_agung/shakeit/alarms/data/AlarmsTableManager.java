...
import edu.upi.mobprog18.tubes_1607479_resky_1600872_agung.shakeit.data.DatabaseTableManager;
...
public class AlarmsTableManager extends DatabaseTableManager<Alarm> {
    ...
    protected ContentValues toContentValues(Alarm alarm) {
        ...
        values.put(AlarmsTable.COLUMN_SUNDAY, alarm.isRecurring(DaysOfWeek.SUNDAY));
        values.put(AlarmsTable.COLUMN_MONDAY, alarm.isRecurring(DaysOfWeek.MONDAY));
        values.put(AlarmsTable.COLUMN_TUESDAY, alarm.isRecurring(DaysOfWeek.TUESDAY));
        values.put(AlarmsTable.COLUMN_WEDNESDAY, alarm.isRecurring(DaysOfWeek.WEDNESDAY));
        values.put(AlarmsTable.COLUMN_THURSDAY, alarm.isRecurring(DaysOfWeek.THURSDAY));
        values.put(AlarmsTable.COLUMN_FRIDAY, alarm.isRecurring(DaysOfWeek.FRIDAY));
        values.put(AlarmsTable.COLUMN_SATURDAY, alarm.isRecurring(DaysOfWeek.SATURDAY));

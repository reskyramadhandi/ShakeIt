...
package edu.upi.mobprog18.tubes_1607479_resky_1600872_agung.shakeit.timepickers;
...
//        return ContextCompat.getColor(context, R.color.accent_color);
        return getColorFromThemeAttr(context, edu.upi.mobprog18.tubes_1607479_resky_1600872_agung.shakeit.R.attr.colorAccent);
    }
...
//        return getColorFromThemeAttr(context, android.R.attr.textColorPrimary);
    ...
    public static boolean isDarkTheme(Context context, boolean current) {
        return resolveBoolean(context, edu.upi.mobprog18.tubes_1607479_resky_1600872_agung.shakeit.R.attr.themeDark, current);
    }
